...
public class SharkSwimmingGoal extends RandomSwimmingGoal {
    ...
    protected Vec3 getPosition() {
        ...
        for(int i = 0; vector3d != null && !this.taskOwner.level().getBlockState(BlockPos.containing(vector3d)).isPathfindable(PathComputationType.WATER) && i++ < 10; vector3d = BehaviorUtils.getRandomSwimmablePos(this.taskOwner, 10, 7)) {
        }
